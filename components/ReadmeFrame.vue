<template>
    ...
    >
        <div
            class="flex items-center gap-[10px] px-[14px] py-[10px] border-b border-line font-mono-chrome text-[12px]"
        ...
        >
            ...
            <span style="color: #7d8590">eric.landheer / main</span>
        ...
        <div class="px-8 py-7 readme-body">
            <Transition name="readme-swap" mode="out-in">
                ...
                <div v-else key="blame" class="font-mono-chrome" style="font-size: 12.5px; color: #cbd5e1">
                    <div
                        ...
                        :key="i"
                        class="py-[6px]"
                        style="display:grid;grid-template-columns:90px 200px 120px 40px 1fr;gap:14px;border-bottom:1px dashed rgba(148,163,184,0.1)"
                    >
                        <span style="color: #22d3ee">{{ r.hash }}</span>
                        <span style="color: #7d8590">{{ r.msg }}</span>
                        <span style="color: #7d8590">{{ r.age }}</span>
