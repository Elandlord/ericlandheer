    ...
    <div class="flex flex-col ">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 py-20 relative mx-8 lg:mx-0">
            <div class="flex justify-center">
                <div class="shadow-md w-full rounded-full overflow-hidden" style="max-width: 400px; max-height: 400px;">
                    <img class="w-full h-full object-cover" src="assets/images/eric-resume.png" />
                </div>
            </div>
